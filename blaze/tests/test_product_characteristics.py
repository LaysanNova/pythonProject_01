...
class TestCharacteristicsByCategories:
    ...
    @pytest.mark.parametrize(
        "locator_categories",
        [
            pytest.param(HomePage.PHONES, marks=pytest.mark.phones, id="Phones"),
            pytest.param(HomePage.LAPTOPS, marks=pytest.mark.laptops, id="Laptops"),
            pytest.param(HomePage.MONITORS, marks=pytest.mark.monitors, id="Monitors"),
        ],
    )
