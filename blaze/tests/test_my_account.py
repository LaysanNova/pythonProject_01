...
class TestMyAccount:
    ...
    def test_login_non_existing_user(self):
        ...
        my_account.sl.wait_and_input_text(
            MyAccount.LOGIN_USER_NAME, "UserDoesNotExist."
        )
    ...
    def test_register_valid_new_user(self):
        ...
        my_account_new.sl.wait_and_input_text(
            MyAccount.REGISTER_USER_NAME, new_user.get("username")
        )
        my_account_new.sl.wait_and_input_text(
            MyAccount.REGISTER_PASSWORD, new_user.get("password")
        )
